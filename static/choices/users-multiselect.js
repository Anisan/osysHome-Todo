(function () {
  var DEFAULT_AVATAR_URL = "/Users/static/Users.png";
  ...
  function destroy(selectEl) {
    if (!selectEl) return;
    if (selectEl._todoChoicesObserver) {
      selectEl._todoChoicesObserver.disconnect();
      selectEl._todoChoicesObserver = null;
    }
    if (selectEl._todoChoicesInstance) {
      selectEl._todoChoicesInstance.destroy();
      selectEl._todoChoicesInstance = null;
    }
    selectEl.classList.remove("todo-awaiting-choices");
  }

  function getValues(selectEl) {
    if (!selectEl) return [];
    if (selectEl._todoChoicesInstance) {
      var value = selectEl._todoChoicesInstance.getValue(true);
  ...
  function init(selectEl) {
    ...
    selectEl._todoChoicesInstance = instance;
    ...
    selectEl._todoChoicesObserver = observer;

    selectEl.classList.remove("todo-awaiting-choices");
    return instance;
  }

  window.TodoUsersMultiSelect = {
    init: init,
    destroy: destroy,
    getValues: getValues
  };
